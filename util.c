...
static PyObject *__pyx_f_4util_get_vac(__Pyx_memviewslice, __Pyx_memviewslice, int, int, int __pyx_skip_dispatch); /*proto*/
...
static PyObject *__pyx_pf_4util_get_vac(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_vel0, __Pyx_memviewslice __pyx_v_vel1, int __pyx_v_n_row, int __pyx_v_n_col); /* proto */
...
static PyObject *__pyx_f_4util_get_vac(__Pyx_memviewslice __pyx_v_vel0, __Pyx_memviewslice __pyx_v_vel1, int __pyx_v_n_row, int __pyx_v_n_col, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_i;
  int __pyx_v_j;
...
static PyObject *__pyx_pw_4util_1get_vac(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_r = __pyx_pf_4util_get_vac(__pyx_self, __pyx_v_vel0, __pyx_v_vel1, __pyx_v_n_row, __pyx_v_n_col);
...
static PyObject *__pyx_pf_4util_get_vac(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_vel0, __Pyx_memviewslice __pyx_v_vel1, int __pyx_v_n_row, int __pyx_v_n_col) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("get_vac", 0);
  ...
  __pyx_t_1 = __pyx_f_4util_get_vac(__pyx_v_vel0, __pyx_v_vel1, __pyx_v_n_row, __pyx_v_n_col, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 8, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static int __Pyx_modinit_function_export_code(void) {
  ...
  if (__Pyx_ExportFunction("get_vac", (void (*)(void))__pyx_f_4util_get_vac, "PyObject *(__Pyx_memviewslice, __Pyx_memviewslice, int, int, int __pyx_skip_dispatch)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
