...
static double __pyx_f_4util_get_vac(__Pyx_memviewslice, __Pyx_memviewslice, int, int, int __pyx_skip_dispatch); /*proto*/
...
static double __pyx_f_4util_get_vac(__Pyx_memviewslice __pyx_v_vel0, __Pyx_memviewslice __pyx_v_vel1, int __pyx_v_n_row, int __pyx_v_n_col, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_i;
  int __pyx_v_j;
  double __pyx_v_sum;
  double __pyx_r;
 ...
 */
      ...
      __pyx_t_7 = __pyx_v_i;
      __pyx_t_8 = __pyx_v_j;
      __pyx_v_sum = (__pyx_v_sum + ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_vel0.data + __pyx_t_5 * __pyx_v_vel0.strides[0]) ) + __pyx_t_6 * __pyx_v_vel0.strides[1]) ))) * (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_vel1.data + __pyx_t_7 * __pyx_v_vel1.strides[0]) ) + __pyx_t_8 * __pyx_v_vel1.strides[1]) )))));
    }
  }
...
static PyObject *__pyx_pw_4util_1get_vac(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("get_vac (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_vel0)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        case  1:
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_vel1)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("get_vac", 1, 4, 4, 1); __PYX_ERR(0, 8, __pyx_L3_error)
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_n_row)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("get_vac", 1, 4, 4, 2); __PYX_ERR(0, 8, __pyx_L3_error)
        }
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_n_col)) != 0)) kw_args--;
        else {
    ...
    __pyx_v_vel0 = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[0]); if (unlikely(!__pyx_v_vel0.memview)) __PYX_ERR(0, 8, __pyx_L3_error)
    __pyx_v_vel1 = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[1]); if (unlikely(!__pyx_v_vel1.memview)) __PYX_ERR(0, 8, __pyx_L3_error)
...
static PyObject *__pyx_pf_4util_get_vac(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_vel0, __Pyx_memviewslice __pyx_v_vel1, int __pyx_v_n_row, int __pyx_v_n_col) {
  ...
  __pyx_t_1 = PyFloat_FromDouble(__pyx_f_4util_get_vac(__pyx_v_vel0, __pyx_v_vel1, __pyx_v_n_row, __pyx_v_n_col, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 8, __pyx_L1_error)
...
static PyMethodDef __pyx_methods[] = {
  {"get_vac", (PyCFunction)__pyx_pw_4util_1get_vac, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
