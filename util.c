 ...
 */
      ...
      __pyx_v_sum = (__pyx_v_sum + ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_vel0.data + __pyx_t_7 * __pyx_v_vel0.strides[0]) ) + __pyx_t_8 * __pyx_v_vel0.strides[1]) ))) * (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_vel1.data + __pyx_t_9 * __pyx_v_vel1.strides[0]) ) + __pyx_t_10 * __pyx_v_vel1.strides[1]) )))));
    }
  }
